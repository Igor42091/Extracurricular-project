...
**Рынок автомобилей в Казахстане представляет собой динамичную и разнообразную индустрию, что может быть полезно для разработки маркетинговых стратегий и принятия стратегических решений в будущем.**

**Библиотеки используемые в проекте: pandas, numpy, matplotlib, seaborn, statistics, re, missingno.**
